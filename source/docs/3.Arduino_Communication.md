...
(4) Then click the button <img src="../_static/media/chapter_3/section_1/media/image5.png" /> to upload the program to the Arduino and wait for it to complete.
...
<img src="../_static/media/chapter_3/section_2/media/image1.png" class="common_img" />
...
(4) Then click the button <img src="../_static/media/chapter_3/section_2/media/image5.png" /> to upload the program to the ESP controller and wait for it to complete.
