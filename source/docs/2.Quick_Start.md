...
(3) Double-click to open the download tool [AIapp-ISP-v6.95E](). In the software, select the correct COM port from the dropdown menu. The COM port number may vary depending on your computer. **Do not select COM1, as it is reserved for system communication.**
...
<img class="common_img"  src="../_static/media/chapter_2/section_1/media/image14.jpeg"   />
