...
(2) Double-click to open the STM32 serial programming software [FlyMcu](). <img src="../_static/media/chapter_4/section_1/media/image3.png" />

(3) Click the "**...**" icon and select the HEX file to be programmed from the path: [Robot\MDK-ARM\Robot]().
...
<img src="../_static/media/chapter_4/section_2/media/image1.png" class="common_img" />
...
(2) Double-click to open the STM32 serial programming software [FlyMcu](). <img src="../_static/media/chapter_4/section_2/media/image3.png" />
